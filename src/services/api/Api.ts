...
const isPowerPlatformMode = import.meta.env.MODE === "power-platform-version" || import.meta.env.MODE === "power-platform-form";
const baseUrl = isPowerPlatformMode ? "/api/data/v9.2/" : "/_api/";
